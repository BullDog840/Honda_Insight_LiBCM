...
{		
	...
	//////////////////////////////////////////////////////////////////////////
		...
		//spoofedVoltage_mV = vPackActual_mV - 132,000 + 120,000   - actualCurrent_A * (vPackActual_mV     - 132,000) / 140
		//spoofedVoltage_V  = vPackActual_V  - 132     + 120       - actualCurrent_A * (vPackActual_V      - 132    ) / 140
		//spoofedVoltage_V  = vPackActual_V  - 12                  - actualCurrent_A * (vPackActual_V/140  - 132/140)
